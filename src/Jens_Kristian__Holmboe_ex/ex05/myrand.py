...
_author_ = 'Sebastian Tobias Becker'
_email_ = 'sebabeck@nmbu.no'
...
if __name__ == '__main__':
    rnd_num_gen = LCGRand(1)
    for rand in rnd_num_gen.random_sequence(10):
        print(rand)
    for i, rand in enumerate(
            rnd_num_gen.infinite_random_sequence()):
